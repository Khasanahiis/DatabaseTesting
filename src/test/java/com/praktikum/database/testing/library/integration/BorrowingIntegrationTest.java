...
public class BorrowingIntegrationTest extends BaseDatabaseTest {
    ...
    void testMultipleBorrowings_BySameUser_ShouldSuccess() throws SQLException {
        ...
        Book book2 = Book.builder()
                .isbn("978integ2" + System.currentTimeMillis())
                .title("Second Integration Test Book - " + faker.book().title())
                .authorId(1)
                .totalCopies(5)
                .availableCopies(5)
    ...
    void testConcurrentBorrowingSimulation_RaceConditionHandling() throws SQLException {
        ...
        assertThat(updatedBook).isPresent().get().satisfies(b -> assertThat(b.getAvailableCopies()).isEqualTo(0));
    ...
    void testDataConsistency_AfterMultipleOperations() throws SQLException {
        ...
        assertThat(borrowing1).isPresent().get().satisfies(b -> assertThat(b.getStatus()).isEqualTo("returned"));
        assertThat(borrowing2).isPresent().get().satisfies(b -> assertThat(b.getStatus()).isEqualTo("borrowed"));
